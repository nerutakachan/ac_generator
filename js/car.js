	...
	const addCarInput = (parent, section, key, val) => {
		...
		inputs.forEach(input => {
			input.addEventListener('input', () => {
				...
				const cameraKeys = ['DRIVEREYES', 'ON_BOARD_PITCH_ANGLE', 'BUMPER_CAMERA_POS', 'BUMPER_CAMERA_PITCH', 'BONNET_CAMERA_POS', 'BONNET_CAMERA_PITCH', 'CHASE_CAMERA_PITCH', 'MIRROR_POSITION'];
